...
export default function Signup({ onSwitchToLogin }: SignupProps): JSX.Element {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-bg px-4 text-text-primary">
      <div className="w-full max-w-md rounded-lg border border-weak bg-surface p-8 shadow-sm">
        <h2 className="mb-4 text-2xl font-semibold text-text-primary">Create account</h2>
        <p className="mb-4 text-sm text-text-secondary">This is a mock signup for demo purposes.</p>
        <input
          value={name}
